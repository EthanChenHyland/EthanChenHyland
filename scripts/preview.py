...
def main():
    ...
    def themed(theme):
        ...
        return result
    html = '''<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Ethan Chen / profile proof</title>
<style>
...
</style><header>ETHAN CHEN / README PROOF · LIGHT / DARK / 375PX</header><main>'''
